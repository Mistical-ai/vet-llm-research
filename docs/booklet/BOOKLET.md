...
**Who this is for.** Chapters 1 through 7, and the short "Running Human
Validation" section right after Chapter 7, are written for a **technical
...
background. Chapter 8 shifts audience entirely — it's written for a
...
**Chapter 8 is also a standalone document.** It's written to work as a
...
6. [Chapter 6 — How Data Provenance Works](#chapter-6--how-data-provenance-works) — how every summary, score, and human review traces back to an exact paper, code version, prompt, and model, and how to use that trail to audit or reproduce a result.
7. [Chapter 7 — The Statistics Behind the Numbers](#chapter-7--the-statistics-behind-the-numbers) — every formula (Wilcoxon, Friedman, bootstrap, Krippendorff's alpha, Cohen's Kappa, TF-IDF/cosine, ROUGE), taught from scratch.
...
8. [Chapter 8 — A Guide for Veterinarian Reviewers](#chapter-8--a-guide-for-veterinarian-reviewers-scoring-ai-written-summaries) — zero-jargon standalone handout for a veterinarian reviewer, also usable as a printable document on its own.
...
verbatim copy of Chapter 8, below). This section is the bridge between
Chapter 7 (the statistics behind the LLM jury's results) and Chapter 8 (what
a reviewer actually experiences): the commands that turn already-judged
...
## Chapter 8 — A Guide for Veterinarian Reviewers: Scoring AI-Written Summaries

> **Note:** This chapter is also distributed on its own as a standalone,
> printable handout for reviewers — see
> [`08_human_validation_guide.md`](08_human_validation_guide.md). It assumes
